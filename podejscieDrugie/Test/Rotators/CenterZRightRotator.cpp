#include "CenterZRightRotator.hpp"
...
CenterZRightRotator::CenterZRightRotator()
	: m_notRotatedPositions({ Position::FRONT, Position::BACK }),
...
bool CenterZRightRotator::move(std::vector<Cubic>& cubics)
{
